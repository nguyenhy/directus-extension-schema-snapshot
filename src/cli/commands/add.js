 ...
 * @param {{schemaType: string, storeDir: string, storeType: string, fileFormat: string, snapshotsDir: string, message?: string, json?: boolean}} options - commander-parsed options
 */
